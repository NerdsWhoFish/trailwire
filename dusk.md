...
`trailwire init` configures MCP and hooks for all three harnesses. Releases use Quill and GoReleaser, with a cask published to `TheOutdoorProgrammer/homebrew-tap`. OpenTelemetry is opt-in and disabled by default.
